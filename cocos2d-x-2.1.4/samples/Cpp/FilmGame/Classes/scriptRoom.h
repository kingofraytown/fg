...
#ifndef __FilmGame__scriptRoom__
#define __FilmGame__scriptRoom__
...
class scriptRoom : public CCLayer, public CCTableViewDataSource, public CCTableViewDelegate
{
public:
    ...
    CREATE_FUNC(scriptRoom);
    };


#endif /* defined(__FilmGame__scriptRoom__) */
