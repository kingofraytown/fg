...
#ifndef __FilmGame__crewRoom__
#define __FilmGame__crewRoom__
...
class crewRoom : public CCLayer, public CCTableViewDataSource, public CCTableViewDelegate
{
public:
    ...
    CREATE_FUNC(crewRoom);
    };


#endif /* defined(__FilmGame__crewRoom__) */
